...
import { createSection } from "@/app/(protected)/schulungsinhalte/actions";
...
export function SectionFormDialog() {
  ...
  async function onSubmit() {
    ...
    setSubmitting(true);
    try {
      await createSection({ name: name.trim(), description });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button size="sm" />}>Neuer Abschnitt</DialogTrigger>
      <DialogContent>
        <DialogHeader>
